...
export {getRandomItemFromItems, getRandomPrice, capitalizeType, createIDgenerator, getRandomSliceFromItems,
  getItemFromItemsById, isEscapeKey, getRandomPicId, updateItem};
